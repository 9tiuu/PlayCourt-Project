                        ...
                        <ul className="space-y-2 font-medium mt-2">
                            {
                                options.map((o, index) => (
                                    <li key={index}>
                                        <a href={o.option_route} className="flex items-center p-3 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-600 hover:transition transition duration-200 hover:duration-200 group">
                                            {o.option_icon}
                                            <span className="flex-1 ms-3 whitespace-nowrap text-gray-900 hover:text-blue-600 transition hover:transition duration-200 hover:duration-200 dark:text-white">
                                                {o.option_name}
                                            </span>
                                        </a>
                                    </li>
