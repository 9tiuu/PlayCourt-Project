            ...
            <div className="px-3 py-3 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between md:px-2">
                    <div className="flex items-center justify-start rtl:justify-end gap-4">
                        ...
                        <img src={Logo} alt="icon" className="max-w-36" />
                    </div>
                    <div className="flex items-center">
                        <div ref={dropdownRef} className="flex items-center ms-3">
                            <div>
                                <button onClick={toggleDropdown} type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-blue-100" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                            ...
                            {   
                                isOpenDropdown && (
                                    <div className="z-50 absolute top-0 p-2 right-0 translate-y-[3.8rem] w-60 mr-2 my-4 text-base list-none bg-white divide-y divide-gray-300 rounded-lg shadow border-gray-100 border" id="dropdown-user">
                                        ...
                                        <ul className="py-1" role="none">
                                            ...
                                            <li>
                                                <button onClick={handleLogout} className="block px-4 py-2 w-full text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                                                    Cerrar sesión
                                                </button>
                                            </li>
                                        </ul>
