...
ChartJS.register(ArcElement, Tooltip, Legend);
    ...
    const VecesReservadaCanchaDeportiva = () => {
  ...
  // Mapeo: cancha_id → contador
    const conteo = {};

    reservas.forEach((res) => {
        const cancha = res.cancha_deportiva;
        if (!cancha) return;

        const id = cancha.id || cancha.cancha_id; // según tu backend
  ...
  // Construir labels y valores
    ...
    const options = {
        ...
        plugins: {
            title: {
                display: true,
                text: "Veces que ha sido reservada cada cancha",
...
export default VecesReservadaCanchaDeportiva;